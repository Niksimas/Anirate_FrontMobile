...
- [x] **10.1** Тёмная / светлая тема — Ionic CSS переменные + переключатель в настройках
- [x] **10.2** Глобальный toast composable (`useToast`) для ошибок и успешных действий
- [x] **10.3** Skeleton-загрузки (`IonSkeletonText`) — добавлены на всех экранах
- [x] **10.4** Pull-to-refresh — добавлен на MyAnime, Friends, Profile, ListsView, ListDetailView
- [x] **10.5** Бесконечный скролл — SearchView, MyAnimeView
...
| 10 — Полировка | 🔄 В процессе (10.6 — офлайн опционально) |
